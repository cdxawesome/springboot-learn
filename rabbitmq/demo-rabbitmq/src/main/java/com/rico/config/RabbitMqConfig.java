...
import com.rico.consts.RabbitConsts;
 ...
 *
 * @author rico
 * @date Created in 2021年5月2日17:27:48
 */
@Slf4j
@Configuration
public class RabbitMqConfig {

    // 如果需要使用相关的发布者确认，或者是想打开多个连接，则需要用CachingConnectionFactory
    @Bean
    public RabbitTemplate rabbitTemplate(CachingConnectionFactory connectionFactory)
    {
        ...
        // true表示当消息通过交换机没有路由到queue时，返回消息数据；false表示没有路由到直接丢弃
